<h1 class="text-lg text-red-500">Lead Details</h1>
        ...
        <tbody class="divide-y whitespace-nowrap dark:divide-gray-700">
            ...
            <tr class="filament-tables-row transition hover:bg-gray-50 dark:hover:bg-gray-500/10">
                <td class="filament-tables-cell dark:text-white">
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">Client Concerns</div>
                    </div>
                </td>
                <td>
            ...
            <tr class="filament-tables-row transition hover:bg-gray-50 dark:hover:bg-gray-500/10">
                <td class="filament-tables-cell dark:text-white">
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">Visible signs</div>
                    </div>
                </td>
                <td>
                    <div class="filament-tables-column-wrapper whitespace-normal">
                        <div class="filament-tables-text-column px-4 py-3 inline-flex items-center space-x-1 rtl:space-x-reverse">
                            {{$lead?->tagsWithType('visible_signs')->implode('name', ', ')}}
                        </div>
                    </div>
                </td>
            </tr>
            <tr class="filament-tables-row transition hover:bg-gray-50 dark:hover:bg-gray-500/10">
                <td class="filament-tables-cell dark:text-white">
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">Source</div>
                    </div>
                </td>
                <td>
                    <div class="filament-tables-column-wrapper">
            ...
            <tr class="filament-tables-row transition hover:bg-gray-50 dark:hover:bg-gray-500/10">
                <td class="filament-tables-cell dark:text-white">
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">Service Type
                        </div>
                    </div>
                </td>
                <td class="filament-tables-cell dark:text-white">
            ...
            <tr class="filament-tables-row transition hover:bg-gray-50 dark:hover:bg-gray-500/10">
                <td class="filament-tables-cell dark:text-white">
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">Received On</div>
                    </div>
                </td>
                <td>
                    <div class="filament-tables-column-wrapper">
                        <div class="filament-tables-text-column px-4 py-3">{{$lead?->received_on}}</div>
                    </div>
                </td>
            </tr>
        </tbody>
